            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/add-product-type" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>New Product type</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/list-productsType" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Products type</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                            <a href="/add-slide" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>New Slide</p>
                                </a>
                                <a href="/list-slide" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List Slide</p>
                                </a>
                            </li>
